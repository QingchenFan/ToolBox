...
iris = pd.read_csv('Predict_Score_baggingInt_5.csv')
#print(iris)
colors = '#585eaa'
'''
# seaborn模块绘制分组散点图
...
# 添加标题
plt.title('Int', size=16, x=0.5, y=0.95, loc='center', color=colors)
plt.savefig('Int.png', bbox_inches='tight', pad_inches=0, dpi=300)
