...
iris = pd.read_csv('Predict_Score_baggingADHD_6.csv')
#print(iris)
'''
# seaborn模块绘制分组散点图
...
# 添加标题
plt.title('ADHD', x=0.5, y=0.95, loc='center', size=16, color='#fab27b')

plt.savefig('ADHD.png', bbox_inches='tight', pad_inches=0, dpi=300)
# ax=plt.gca()
