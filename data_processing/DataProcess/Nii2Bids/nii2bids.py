...
BIDSpath = '/Users/fan/Documents/Data/HCPData/HCPDtest/HCPD_BIDS/'
FuncPath = '/Users/fan/Documents/Data/HCPData/HCPDtest/rsfMRI'
...
funcfile = glob.glob('/Users/fan/Documents/Data/HCPData/HCPDtest/rsfMRI/*/MNINonLinear/Results/rfMRI_REST1_AP/*')
for i in funcfile:
    fname = i[50:60]
    funcName = 'sub-'+fname
...
#-------------------------------------------------------------------------------------------------------------------------
T1wPath = '/Users/fan/Documents/Data/HCPData/HCPDtest/sMRI'
...
for i in T1wName:
    ...
    print('/Users/fan/Documents/Data/HCPData/HCPDtest/sMRI/'+i+'/unprocessed/T1w_MPR_vNav_4e_e1e2_mean/*.nii.gz')
    t1wfile = glob.glob('/Users/fan/Documents/Data/HCPData/HCPDtest/sMRI/'+i+'/unprocessed/T1w_MPR_vNav_4e_e1e2_mean/*.nii.gz')
