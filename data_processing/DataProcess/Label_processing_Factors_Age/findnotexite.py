...
with open('/Users/fan/Documents/Data/ABCD_HCP/file_name_hcp.csv', mode='r') as data_1:  # 多
    data_1 = data_1.readlines()

with open('/Users/fan/Documents/Data/ABCD_HCP/ABCD_HCP_Label.csv', mode='r')as data_2:  # 少
