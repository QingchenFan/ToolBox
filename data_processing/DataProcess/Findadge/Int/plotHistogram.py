...
df = pd.read_csv('./Gorden_Int_res/Int_res_20.csv')
x_name = df['roi']
...
sns.barplot(x=x, y=y1, data=df, palette="Purples_r", hue='roi2', dodge=False, ax=ax1, ci=None)
ax1.set_xticklabels(df['roi'], rotation=50, fontsize=14, font='Aprial')
ax1.axhline(0, color="k", clip_on=True)
ax1.set_xlabel("networks")
ax1.set_ylabel("Rank of Weights")
ax1.set_title("Int", size=28)
# Finalize the plot
