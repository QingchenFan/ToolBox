...
df = pd.read_csv('./Gorden_ADHD_res/ADHD_res_20.csv')
x_name = df['roi']
...
sns.barplot(x=x, y=y1, data=df, palette="Wistia_r", hue='roi2', dodge=False, ax=ax1, ci=None)
