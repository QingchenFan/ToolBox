...
df = pd.read_csv('./Gorden_Ext_res/Ext_res_20.csv')
x_name = df['roi']
...
sns.barplot(x=x, y=y1, data=df, palette="OrRd_r", hue='roi2', dodge=False, ax=ax1, ci=None)
