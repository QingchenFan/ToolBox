...
print(dir(nib.cifti2.cifti2_axes.ScalarAxis))
...
nib.Cifti2Image(data, val_head, labeldata.nifti_header, labeldata.extra, labeldata.file_map).to_filename('./fcvalue.dscalar.nii')
