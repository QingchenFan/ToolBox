...
# 1. 读入数据
df = pd.read_csv('/Users/qingchen/Desktop/ADII_PD_Bold.csv')

# 2. 需要检查的指标
metrics = ['aor', 'aqi', 'dvars_std', 'dvars_vstd', 'snr', 'tsnr']
...
serious_df.to_csv('/Users/qingchen/Desktop/ADII_PD_Bold_outliers.csv', index=False)