...
# 使用mask获取所有体素灰质信息
seedmask = '/Volumes/QCI/ZY_SeedFC/rRight_Amygdala_LB.nii'

brainmask = '/Volumes/QCI/ZY_SeedFC/GMmask.nii.gz'
outpath = '/Volumes/QCI/ZY_SeedFC/zy_seedFC_rRigt_Amygdala_LB_MDDduilie/'
imgePath = '/Volumes/QCII/duilie_processed/duilie_HC_MDD_fmriprep/sub-MDD*/sub-MDD*/func/*_task-rest_acq-ap_run-1_space-MNI152NLin6Asym_res-2_desc-preproc_bold.nii.gz'
...
for i in file:
    ...
    ex = outpath + subID + '_seedtovoxel.nii.gz'

    if subID in ["sub-MDD123V01"]:
        continue
