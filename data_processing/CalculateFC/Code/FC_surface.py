...
dirc_L = 'Code/metric_index_L.txt'
select_ind_L = np.loadtxt(dirc_L).astype(int)

dirc_R = 'Code/metric_index_R.txt'
...
# 获取数据数组和标签数组
cifti_label_path = 'Datafc/Schaefer2018_400Parcels_7Networks_order.dlabel.nii'
...
savemat('/Users/qingchen/Documents/code/ToolBox/data_processing/CalculateFC/Code/sub06202.mat', {'data': resFC})
